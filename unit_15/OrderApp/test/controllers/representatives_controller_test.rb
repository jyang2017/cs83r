...
class RepresentativesControllerTest < ActionController::TestCase
  ...
  test "should create representative" do
    assert_difference('Representative.count') do
      post :create, representative: { first_name: @representative.first_name, hire_date: @representative.hire_date, last_name: @representative.last_name, phone: @representative.phone, region: @representative.region }
    end
  ...
  test "should update representative" do
    patch :update, id: @representative, representative: { first_name: @representative.first_name, hire_date: @representative.hire_date, last_name: @representative.last_name, phone: @representative.phone, region: @representative.region }
    assert_redirected_to representative_path(assigns(:representative))
  end
