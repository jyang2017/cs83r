...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { description: @inventory.description, quantity_on_hand: @inventory.quantity_on_hand }
    end
  ...
  test "should update inventory" do
    patch :update, id: @inventory, inventory: { description: @inventory.description, quantity_on_hand: @inventory.quantity_on_hand }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
